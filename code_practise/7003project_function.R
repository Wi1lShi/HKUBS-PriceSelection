...
# function part, simplify the method
...
# function to see the total_profit
...
# function to see the total_revenue
...
# combine function to get total_profit
t_p <- function(p){
  df = d_trans(p)
  return(t_profit(p, df))
}
...
print(sum(decision_trans$perchase_or_not))
